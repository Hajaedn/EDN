...
<form method="post" action="update_usr.php">
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="Nom" type="text" name="usr_name" value="<?php echo $userSelected->getName(); ?>"/>
    </div>
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="Pass" name="usr_pwd" value="<?php echo $userSelected->getPassword(); ?>"/>
        </div>
    </div>
